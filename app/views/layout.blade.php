...
<html ng-app="expenses">
  <head>
    ...
    <script src="{{ asset('js/services/userService.js') }}"></script>
    <script src="{{ asset('js/services/authorService.js') }}"></script>
    <script src="{{ asset('js/services/categoryService.js') }}"></script>
    <script src="{{ asset('js/services/activityService.js') }}"></script>
